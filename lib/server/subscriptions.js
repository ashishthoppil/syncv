...
// Free-trial allowance for logged-in users without an active subscription.
// Lifetime (not weekly): once exhausted, the user must subscribe.
export const FREE_TRIAL_PLAN_KEY = "free";
export const FREE_TRIAL_SCAN_LIMIT = 3;
