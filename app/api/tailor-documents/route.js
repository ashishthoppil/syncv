  ...
  try {
    ...
    if (uncoveredAfterPass1.length) {
      const revisionPrompt = [
        ...
        "- Add a keyword that names a method, practice, or broad concept (e.g. code review, documentation, distributed computing, system design) by REWORDING the experience or project bullet where the candidate performed that work so it reads naturally. Spread these across different roles. Only if no bullet plausibly fits may it go into a related skills category — never into a catch-all bucket named 'Concepts', 'Additional', 'Other', or 'Miscellaneous'.",
